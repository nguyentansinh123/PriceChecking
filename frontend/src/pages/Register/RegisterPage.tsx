  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="flex w-[1200px] h-[650px] bg-white rounded-2xl overflow-hidden shadow-lg relative">
        ...
        <div className="flex-[3] flex flex-col items-center justify-center p-10">
          <div className="w-full max-w-sm">
            ...
            <form>
              ...
              <Link
                to="/login"
                className="block text-sm italic text-[#00004C] mb-6 hover:underline"
              >
        ...
        {/* Right: Blue slanted cloud panel */}
        <div
        ...
        >
          ...
          <div
            className="absolute top-0 left-[-40px] h-full w-[80px] pointer-events-none"
            style={{
